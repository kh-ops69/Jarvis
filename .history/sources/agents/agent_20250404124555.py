        ...
        self.json_format = """
{
  "plan": [
    ...
    def format_llm_request(self, unformatted_llm_response):
        ...
        {
            'role': 'user',
            'content': f'retrieve only the JSON response from this object: {unformatted_llm_response}. \n In case the given object is not in JSON format, make it JSON formatted as per the following format: {self.json_format}',
        },
        ])
