...
class GeminiAgent(Agent):
    ...
    def process(self, prompt, speech_agent):
        # Call Gemini API
...
if __name__=='__main__':
    gem = GeminiAgent(name="Gemini",
            prompt_path=f"/Users/krishhashia/Downloads/agenticSeek-main/prompts/jarvis/gemini_agent.txt",
            )
    print(gem.process(input('Enter trial input: ')))