...
# provider is initialised first- the main class in main.py file initialises provider with the provided details in config.ini
# all the related functions to check and initialise the model are present in this class as functions 
...
class Provider:
    def __init__(self, provider_name, model, server_address = "127.0.0.1:5000", is_local=False):
        ...
        # default server ip is localhost:11434 as described in config.ini as that port is used by ollama for accessing any model 
        # downloaded through ollama

        # in case ollama server is not started before, it will give the below error. start ollama server and try running again
    ...
    # in case you plan on using a cloud provider, you need an api key
    # api keys are usually stored as environment variables for extra security 
