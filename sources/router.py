...
class AgentRouter:
    ...
    def learn_few_shots_complexity(self) -> None:
        ...
        few_shots = [
            ...
            ("Summarize pros and cons of smartphone and store them in a text file", "HIGH"),
            ("hi", "LOW"),
            ("Bonjour", "LOW"),
            ("What's up ?", "LOW"),
        ]
    ...
    def learn_few_shots_tasks(self) -> None:
        ...
        few_shots = [
            ...
            ["Create a new folder called directory_name and add files to it", "code"],
            ["Add this file to a new directory called test_directory and add code for binary search algorithm to it", "code"],
            ("Summarize pros and cons of smartphone and store them in a text file", "gemini"),
    ...
    def select_agent(self, text: str) -> Agent:
        ...
        if complexity == None:
            pretty_print(f"Hmm, the task seems to be complex but you gave very little information. can you clarify?", color="info")
            return None
